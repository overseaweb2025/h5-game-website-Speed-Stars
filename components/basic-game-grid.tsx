  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden hover:scale-105 transition-transform cursor-pointer">
          <img 
            ...
            onError={(e) => {
              ...
              target.src = "https://via.placeholder.com/300x200/6B7280/ffffff?text=Crazy+Cattle+3D";
            }}
          />
          <div className="p-3">
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden hover:scale-105 transition-transform cursor-pointer">
          <img 
            src="https://via.placeholder.com/300x200/4F46E5/ffffff?text=Racing+Game"
            alt="Racing Game"
            className="w-full h-32 object-cover"
          />
          <div className="p-3">
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden hover:scale-105 transition-transform cursor-pointer">
          <img 
            src="https://via.placeholder.com/300x200/059669/ffffff?text=Puzzle+Game"
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden hover:scale-105 transition-transform cursor-pointer">
          <img 
            src="https://via.placeholder.com/300x200/DC2626/ffffff?text=Action+Hero"
            alt="Action Hero"
            className="w-full h-32 object-cover"
          />
          <div className="p-3">
