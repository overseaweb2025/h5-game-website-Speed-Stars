    ...
    <section className="py-6 md:py-8 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="md:w-1/2">
            <h3 className="text-2xl font-bold mb-3 text-text">Speed Stars Unblocked - Play Free Online</h3>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="bg-accent/30 text-text px-3 py-1 rounded-full text-sm font-medium">
                #Physics-Based Gameplay
              </span>
              <span className="bg-accent/30 text-text px-3 py-1 rounded-full text-sm font-medium">#Free Online</span>
              <span className="bg-accent/30 text-text px-3 py-1 rounded-full text-sm font-medium">#Unblocked</span>
              <span className="bg-accent/30 text-text px-3 py-1 rounded-full text-sm font-medium">#Competitive</span>
            </div>
          </div>
        </div>
      </div>
