        ...
        <div className="col-span-3">
          ...
          {homeData ? (
            <img
              ...
              alt={homeData?.title || 'Free Game' || " Game"}
        ...
        {homeData?.page_content?.About && (
          <div className="col-span-3 mt-6">
            <div className="max-w-4xl mx-auto">
              <div 
                className="content_warp prose prose-lg max-w-none text-text/80 leading-relaxed [&>h1]:text-text [&>h2]:text-text [&>h3]:text-text [&>h4]:text-text [&>h5]:text-text [&>h6]:text-text [&>p]:text-text/80 [&>ul]:text-text/80 [&>ol]:text-text/80 [&>li]:text-text/80 [&>a]:text-primary [&>a]:hover:text-primary/80 [&>strong]:text-text [&>b]:text-text"
